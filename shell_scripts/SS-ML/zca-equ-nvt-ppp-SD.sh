...
cp $BASE_DIR/$SYS_NAME/$SYS_NAME-10000-${3}-${4}-${5}.data $RUN_DIR
cd $RUN_DIR
...
read_data $SYS_NAME-10000-${3}-${4}-${5}.data
...
rm $RUN_DIR/$SYS_NAME-10000-${3}-${4}-${5}.data
