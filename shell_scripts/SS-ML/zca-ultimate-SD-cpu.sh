...
export LMP_CMD="srun -n 240 /scratch/rmnvm/ary.junior/opt/lammps-16Feb16_ARY/src/lmp_mpi_fftw3_SD_update"
...
### Rodando a simulacao ###
export RUN_DIR="$BASE_DIR/$SYS_NAME/c/md/lammps/ultimate/$ID_RUN"
mkdir -p $RUN_DIR
...
fix zrf zr ave/time 1 1 1 c_zrc[1] c_zrc[2] c_zrc[3] c_zrc[4] 
