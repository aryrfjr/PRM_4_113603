...
### Rodando a simulacao ###
export RUN_DIR="$BASE_DIR/$SYS_NAME/c/md/lammps/ultimate/2/${2}"
mkdir -p $RUN_DIR
...
compute gzrc gzr msd
compute gcuc gcu msd
compute galc gal msd

fix gzrf gzr ave/time 10 10 100 c_gzrc[1] c_gzrc[2] c_gzrc[3] c_gzrc[4] file G1Zr.msd
fix gcuf gcu ave/time 10 10 100 c_gcuc[1] c_gcuc[2] c_gcuc[3] c_gcuc[4] file G1Cu.msd
fix galf gal ave/time 10 10 100 c_galc[1] c_galc[2] c_galc[3] c_galc[4] file G1Al.msd
