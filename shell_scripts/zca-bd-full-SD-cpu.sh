...
export LMP_CMD="srun --resv-ports --nodes 4 --ntasks=96 /scratch/rmnvm/ary.junior/opt/lammps-16Feb16_ARY/src/lmp_mpi_fftw3_SD_update"
...
### Rodando a simulacao ###
for ID_RUN in `seq $((FID_RUN)) $((FID_RUN+5))`
do
