...
#PBS -m abe
#PBS -N zca-bd-full
#PBS -o zca-bd-full_out
#PBS -e zca-bd-full_err
#PBS -V
...
### Carrega a biblioteca MPI da SGI ###
export PATH=/opt/sgi/mpt/mpt-2.03/bin:$PATH
export LD_LIBRARY_PATH=/opt/sgi/mpt/mpt-2.03/lib:$LD_LIBRARY_PATH
...
export LMP_CMD="mpiexec_mpt -np 96 /home/ice/proj/proj691/aryjr/opt/lammps-16Feb16_ARY/src/lmp_xeon"

### Variaveis de controle da simulacao ###
export SYMBS=(Zr Cu Al)
export NATS=(43 43 14)
export NAT=100
export BD_DIR="/home/ice/proj/proj691/aryjr/MG-NMR/ML/big-data-full"
...
# Numeros randomico utilizado pelo LAMMPS
